...
/*
	...
	1�� ȱʡ���ⲿ����Ƶ����25MHz�� PLL��Ƶ�� 168MHz ��ΪCPUϵͳʱ�ӡ�
	...
	3�� �����Ҫ������λ��CPU�ڲ������ "VECT_TAB_SRAM" �궨�壬ȱʡ�Ǳ�ע�͵��ġ�
		...
		������STM32-V5������SRAM���ߺ�ST�̼���ȱʡӲ����֮ͬ����
		a) ������ PE5/FSMC_A21������Ƭѡһ�����롣ST��û������PE5��
		b) Ƭѡ�ܽŲ�ͬ��ST����PG9/FSMC_NE2, ��������STM32-V5�� PG10/FSMC_NE3
	
	4��"DATA_IN_ExtSRAM" �� "VECT_TAB_SRAM" ��������Ҳ�����ڹ��������� predefine ������ָ����
	
	5�� SystemCoreClock ȫ�ֱ�����ʾϵͳ��Ƶ��Hz����ȱʡ�� 168000000. ��C�����п���ֱ��ʹ�ø�ȫ�ֱ�����
...
��������STM32-V5������ �ⲿSRAM ���߷��䡿
	...
	PE0/FSMC_NBL0		--- SRAM�ֽ�ѡͨ
	PE1/FSMC_NBL1		--- SRAM�ֽ�ѡͨ
	PE3/FSMC_A19
	PE4/FSMC_A20		--- ����Ƭѡһ������
	PE5/FSMC_A21		--- ����Ƭѡһ������
	PE7/FSMC_D4
